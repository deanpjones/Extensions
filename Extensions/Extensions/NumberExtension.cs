...
namespace Extensions.Extensions
{
    ...
    public static class NumberExtension
    {
        ...
        //  rounded = the # of decimal places to round to 
        //(note there are decimal errors prone in double object, test on interactive terminal with / and %)
        public static double Round(this double d, int rounded)
        {
            return Math.Round(d, rounded);
        }
        ...
        //TEST FOR INT (int = Int32)
        public static bool isInt32(this object o)
        {
            bool result;
            if (Type.GetTypeCode(o.GetType()) == TypeCode.Int32)
            {
                result = true;
            }
            else
        ...
        //GET LAST (nth) DIGITS (INT)
        public static int GetLastNthDigits(this int n, int digits)
        {
            return n % (int)Math.Pow(10, digits);     //n mod 10 will return the last digits
        }
        //public static int GetLastNthDigits(this int n, int digits)
        //{
        //    int lastDigits;
